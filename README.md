## cert-manager on kind cluster

# docs
- https://github.com/helm/helm
- https://docs.cilium.io/en/v1.9/cmdref/cilium-operator/

## docs - kind
- https://blog.gripdev.xyz/2020/01/15/use-kind-kubernetes-in-docker-in-ci-cd-reliably/
- https://github.com/kubernetes-sigs/kind

## cert-manager
- https://cert-manager.io/docs/configuration/
- https://cert-manager.io/docs/usage/certificate/
- https://github.com/jetstack/cert-manager-csi/blob/master/deploy/cert-manager-csi-driver.yaml
...
## ginkgo
- https://github.com/kubernetes/kubernetes/blob/ddf47ac13c1a9483ea035a79cd7c10005ff21a6d/test/e2e/storage/drivers/csi.go#L192-L209
- https://github.com/czhujer/h-platform-automation-cc-server/blob/add-tests/main_test.go#L42-L73
- https://github.com/kubernetes/kubernetes/blob/master/test/integration/deployment/deployment_test.go
- https://github.com/ovn-org/ovn-kubernetes/tree/master/test/e2e
